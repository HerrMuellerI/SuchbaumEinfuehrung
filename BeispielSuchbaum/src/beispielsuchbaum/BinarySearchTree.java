...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
	...
	private BSTNode<ContentType> node;
        ...
        public static void main(String [] args){
            BinarySearchTree<Zahleninhalt> meinSuchbaum;
            meinSuchbaum = new BinarySearchTree<>();
            Zahleninhalt zahl1 = new Zahleninhalt(1);
            Zahleninhalt zahl2 = new Zahleninhalt(2);
            Zahleninhalt zahl3 = new Zahleninhalt(3);
            Zahleninhalt zahl4 = new Zahleninhalt(4);
